...
const fadeUp = {
  ...
  const highlights = [
    ...
    [Trophy, "Top 2%", "Scientist Worldwide", "Stanford University Global Ranking"],
    [Building2, "3", "Companies Founded", "Building innovative solutions for impact"],
  ...
  <div className="relative z-20 max-w-[1180px] mx-auto w-full px-[46px] max-lg:px-6">
    <div className="w-[455px] max-w-full xl:pt-[10px] md:pt-[2px]">
      ...
      <p className="text-[13px] leading-[1.65] text-[#4f4f4f] max-w-[390px]">
        Ranked in the Top 2% of Scientists Worldwide for scientific
        impact and innovation with 300+ research papers in reputed
        ...
        {stats.map(([num, label], index) => (
          ...
          >
            <div className="flex justify-center text-[#b87518] mb-[8px]">
              ...
              {index === 3 && <GraduationCap size={21} strokeWidth={1.6} />}
            </div>
    ...
    <div className="grid lg:grid-cols-[42%_58%] gap-10 lg:gap-12 mt-9 items-start">
      ...
      <div>
        <p className="text-[14px] leading-[1.85] text-[#3f3e3e] max-w-[430px]">
          I am a researcher, educator, and entrepreneur dedicated to solving
          real-world challenges through innovative research and emerging
          technologies. My work spans multiple domains with a mission to create
          sustainable and scalable impact for society.
        </p>
      ...
      {highlights.map(([Icon, title, sub, desc]) => (
        ...
        >
          <div className="w-[66px] h-[66px] rounded-full bg-[#f5eee6] flex items-center justify-center shrink-0">
            <Icon size={34} strokeWidth={1.5} className="text-[#b87518]" />
          </div>
    ...
    {o.fullName && (
      <p className="text-[15px] font-semibold text-[#1A1A1A] mt-0.5 leading-snug">
        {o.fullName}
                ...
                <p className="text-[13.5px] text-[#1A1A1A] leading-[1.75] mb-5">{o.desc}</p>
<a
  href={o.link}
  target="_blank"
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[20px]">
      {[
        ...
        >
          ...
          <p className="text-[13px] text-[#333] mt-[4px]">
            {year}
          </p>
